...
Module DepthFirstSearch
    ...
    End Sub
    Sub DFS_Iterative(availablepath As Dictionary(Of Node, List(Of Node)), showPath As Boolean, showSolveTime As Boolean, delay As Integer, solvingColour as ConsoleColor)
